...
if (typeof openPage !== "function") {
  window.openPage = printed => {
    location.href = "manual.html?page=" + printed;
  };
}
...
const store = {
  get(k) {
    try {
      return JSON.parse(localStorage.getItem("xh2s_" + k));
    } catch (e) {
      return null;
    }
  },
  set(k, v) {
    try {
      localStorage.setItem("xh2s_" + k, JSON.stringify(v));
      return true;
    } catch (e) {
      return false;
    }
