...
export const TUTORIAL = [
  ...
  { id: "tut8", num: 8, title: "Dein Lernpfad zum Enthusiasten", minutes: "PLAN", type: "mixed",
    body: "<p><b>Phase 1 — vor der Reise:</b> Tutorial-Kapitel 1–3 + Presets verifizieren und auf der Seite „Belegung“ eintragen + auf der Seite „Verbindung“ XApp koppeln &amp; Backup + Übungen 1–3.</p><p><b>Phase 2 — auf der Reise:</b> 80 % einfach fotografieren, 20 % bewusst gestalten (±-Korrektur, Fokusfeld schieben, 1× täglich Modus A) + Übungen 4–6.</p><p><b>Phase 3 — danach:</b> Bilder sichten, EXIF-Werte der Lieblingsbilder anschauen, Kapitel 4–6 nochmal lesen, pal2tech abonnieren.</p><p class=\"hint\">Die abhakbaren Übungen findest du auf der Seite „Übungen“.</p>" },
];
